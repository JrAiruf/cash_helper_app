...
//CRIAR
  Future<void>? createNewAnnotation(String enterpriseId, AnnotationEntity annotation) async {
    final newAnnotation = await _createNewAnnotation(enterpriseId, annotation);
