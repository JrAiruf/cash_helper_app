...
class GetEnterpriseByCodeBloc
    extends Bloc<GetEnterpriseByCodeEvents, GetEnterpriseByCodeStates> {
  ...
  void _mapGetEnterpriseByCodeEventToState(GetEnterpriseByCodeEvent event,
      Emitter<GetEnterpriseByCodeStates> state) async {
