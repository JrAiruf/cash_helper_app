...
const customcolor1 = Color(0xFF69C74E);


CustomColors lightCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF69C74E),
  customcolor1: Color(0xFF176E00),
  onCustomcolor1: Color(0xFFFFFFFF),
  customcolor1Container: Color(0xFF98FA79),
  onCustomcolor1Container: Color(0xFF032100),
);

CustomColors darkCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF69C74E),
  customcolor1: Color(0xFF7DDD60),
  onCustomcolor1: Color(0xFF083900),
  customcolor1Container: Color(0xFF0F5300),
  onCustomcolor1Container: Color(0xFF98FA79),
);
